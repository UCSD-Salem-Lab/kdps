...
# Complex Example: Larger Relatedness Network

```{r,eval=FALSE}
phenotype_file = system.file("extdata", "complex_pheno.txt", package = "kdps")
kinship_file   = system.file("extdata", "complex_kinship.txt", package = "kdps")
